...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" version="XHTML+RDFa 1.0" dir="<?php print $language->dir; ?>">
  <head>
    ...
    <style>
      <?php
        // Added to ensure css is loaded for PDF - see https://www.drupal.org/node/671972#comment-10788212.
        global $base_url;
        $css = file_get_contents($base_url . '/sites/all/themes/thinkcollege_boot/css/program-record-pdf.css');
        print $css;
      ?>
    </style>
  </head>
