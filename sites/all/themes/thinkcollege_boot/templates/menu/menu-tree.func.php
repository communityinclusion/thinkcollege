 ...
 */
function thinkcollege_boot_menu_tree(array &$variables) {
 ...
 *   The constructed HTML.
 */
function thinkcollege_boot_menu_tree__primary(array &$variables) {
  return '<ul class="menu nav navbar-nav">' . $variables['tree'] . '</ul>';
}
 ...
 *   The constructed HTML.
 */
function thinkcollege_boot_menu_tree__secondary(array &$variables) {
 ...
 *   The constructed HTML.
 */
function thinkcollege_boot_menu_tree__book_toc(array &$variables) {
 ...
 *   The constructed HTML.
 */
function thinkcollege_boot_menu_tree__book_toc__sub_menu(array &$variables) {
