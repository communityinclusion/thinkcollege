(function($) {
 ...
 Drupal.behaviors.groupTopics = {
     attach: function (context, settings) {
      ...
      if !$('.form-item form-type-textfield form-item-field-resourc-authors-und p.warnSelect').length) {

        $('.form-item form-type-textfield form-item-field-resourc-authors-und label').after('<p class="warnSelect">The lastname, firstname terms have to have double quotes around them like so: "Lastname, Firstname" Additional terms should be separated by commas between the double quotes, like so: "Lastname1, Firstname1","Lastname2, Firstname2" and so on.</p>'); }
