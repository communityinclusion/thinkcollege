...
if (is_array($favorites)) {
  if (count($favorites)) {
    ...
    foreach ($favorites as $nid => $title) {
      ...
      ?>
        <div class="saved"><p><a
                        href="/collegesearch/favorite/remove/<?php print $nid ?>?destination=<?php print current_path() ?>">X</a> <?php print $titlelink ?>
            </p></div>
      <?php
    ...
    ?>
      <div class="saved"<p><a
                  href="/collegesearch/favorite/remove/clearall?destination=<?php print current_path() ?>"><span
                      style="color: red;font-weight: bold">X</span> Clear all
              favorites</a></p></div>
      <div class="btn-group">
